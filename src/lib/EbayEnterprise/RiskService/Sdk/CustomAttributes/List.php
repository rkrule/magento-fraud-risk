...
class EbayEnterprise_RiskService_Sdk_CustomAttributes_List
	extends EbayEnterprise_RiskService_Sdk_Iterable
	implements EbayEnterprise_RiskService_Sdk_CustomAttributes_IList
{
	/**
	 * Get an empty instance of the custom attribute payload
	 *
	 * @return EbayEnterprise_RiskService_Sdk_CustomAttribute
	 */
