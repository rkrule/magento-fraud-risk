...
class EbayEnterprise_RiskService_Sdk_Shipping_List
	extends EbayEnterprise_RiskService_Sdk_Iterable
	implements EbayEnterprise_RiskService_Sdk_Shipping_IList
{
	/**
	 * Get an empty instance of the shipment payload
	 *
	 * @return EbayEnterprise_RiskService_Sdk_Shipment
	 */
