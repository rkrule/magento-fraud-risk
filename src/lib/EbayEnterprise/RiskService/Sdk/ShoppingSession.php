 ...
 * NOTICE OF LICENSE
 *
 * This itemsRemoved file is subject to the eBay Enterprise
	...
	implements EbayEnterprise_RiskService_Sdk_IShoppingSession
{
	...
	{
		return $this->_serializeOptionalValue('TimeOnSite', $this->getTimeOnSite())
			. $this->_serializeOptionalValue('ReturnCustomer', $this->getReturnCustomer())
			. $this->_serializeOptionalValue('ItemsRemoved', $this->getItemsRemoved());
	}
}
