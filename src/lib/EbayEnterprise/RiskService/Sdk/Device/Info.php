...
class EbayEnterprise_RiskService_Sdk_Device_Info
	extends EbayEnterprise_RiskService_Sdk_Payload
	implements EbayEnterprise_RiskService_Sdk_Device_IInfo
{
	/** @var string */
	protected $_deviceIP;
	/** @var string */
	...
	/** @var EbayEnterprise_RiskService_Sdk_Http_Headers */
	...
	/**
	 * @see EbayEnterprise_RiskService_Sdk_Device_IInfo::getDeviceIP()
	 */
	...
	/**
	 * @see EbayEnterprise_RiskService_Sdk_Device_IInfo::setDeviceIP()
	 */
	...
	/**
	 * @see EbayEnterprise_RiskService_Sdk_Device_IInfo::getHttpHeaders()
	 */
	...
	/**
	 * @see EbayEnterprise_RiskService_Sdk_Device_IInfo::setHttpHeaders()
	 */
