...
interface EbayEnterprise_RiskService_Sdk_Feedback_IResponse extends EbayEnterprise_RiskService_Sdk_Payload_ITop
{
	const ROOT_NODE = 'RiskServiceFeedbackResponse';
	const XML_NS = 'http://api.gsicommerce.com/schema/checkout/1.0';
	const XSD = 'RiskServiceFeedbackResponse.xsd';
