...
class EbayEnterprise_RiskService_Sdk_OrderConfirmationRequest
	extends EbayEnterprise_RiskService_Sdk_Payload_Top
	implements EbayEnterprise_RiskService_Sdk_IOrderConfirmationRequest
{
	/** @var EbayEnterprise_RiskService_Sdk_IOCROrder **/
	protected $_order;
	...
	/**
	 * @see EbayEnterprise_RiskService_Sdk_IOrderConfirmationRequest::getOrder()
	 */
	...
	/**
	 * @see EbayEnterprise_RiskService_Sdk_IOrderConfirmationRequest::setOrder()
	 */
