...
interface Radial_RiskService_Sdk_IOrderConfirmationRequest extends Radial_RiskService_Sdk_Payload_ITop
{
	const ROOT_NODE = 'RiskOrderConfirmationRequest';
	const XML_NS = 'http://api.gsicommerce.com/schema/checkout/1.0';
	const XSD = 'Risk-OrderConfirmationRequest-1.0.xsd';
	const ORDER_MODEL ='Radial_RiskService_Sdk_OCROrder';

	/**
	 * Order
	 *
	 * @return Radial_RiskService_Sdk_IOCROrder 
	 */
