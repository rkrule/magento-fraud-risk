...
class Radial_Dom_Element extends DOMElement
{
	 ...
	 * @return Radial_Dom_Element the created Radial_Dom_Element
	 */
	 ...
	 * @see Radial_Dom_Document::setNode
	 * @param string         $path
