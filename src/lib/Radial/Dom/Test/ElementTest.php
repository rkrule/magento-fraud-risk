...
class Radial_Dom_Test_ElementTest extends PHPUnit_Framework_TestCase
{
	public function setUp()
	{
		$this->doc = new Radial_Dom_Document();
...
<testroot><childElement xmlns="http://api.gsicommerce.com/schema/checkout/1.0" ref="1"><![CDATA[test element addChild method]]></childElement></testroot>';
	...
	{
		$doc = $this->getMockBuilder('Radial_Dom_Document')
		...
		$createdNode = $this->getMockBuilder('Radial_Dom_Element')
