...
class Radial_Dom_Test_DocumentTest extends PHPUnit_Framework_TestCase
{
	/**
	 */
	public function testUsage()
	{
		$doc = new Radial_Dom_Document();
	...
	{
		$doc = new Radial_Dom_Document('1.0', 'UTF-8');
...
<root xmlns="http://api.gsicommerce.com/schema/checkout/1.0"><![CDATA[test with CreateElement method]]></root>';
	...
	{
		$doc = new Radial_Dom_Document('1.0', 'UTF-16');
