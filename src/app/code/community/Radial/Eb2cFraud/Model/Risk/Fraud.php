...
class Radial_RiskService_Model_Risk_Fraud
	implements Radial_RiskService_Model_Risk_IFraud
{
	/** @var Mage_Sales_Model_Order */
	protected $_order;
	/** @var Radial_RiskService_Helper_Data */
	protected $_helper;

	/**
	 * @param array $initParams Must have this key:
	 *                          - 'order' => Mage_Sales_Model_Order
	 *                          - 'helper' => Radial_RiskService_Helper_Data
	 */
	 ...
	 * @param  Radial_RiskService_Helper_Data
	 * @return array
	 */
	protected function _checkTypes(
		Mage_Sales_Model_Order $order,
		Radial_RiskService_Helper_Data $helper
	) {
	 ...
	 *
	 * @param  string
	 * @return Radial_RiskService_Model_Risk_Insight
	 */
