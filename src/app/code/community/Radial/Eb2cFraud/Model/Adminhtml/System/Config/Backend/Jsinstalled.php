 ...
 */
class Radial_Eb2cFraud_Model_Adminhtml_System_Config_Backend_Jsinstalled extends Mage_Core_Model_Config_Data
{
    /**
     * Load display variable with 'Yes' or 'No' regarding javascript file presence in radial_eb2cfraud location
     * @return self
