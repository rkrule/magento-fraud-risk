 ...
 *
 */
class Radial_Eb2cFraud_Helper_Data extends Mage_Core_Helper_Abstract
{
	...
	/**
    	...
    	public function __construct(array $args = [])
    	{
			...
			$this->_nullCoalesce('config', $args, Mage::helper('radial_eb2cfraud/config'))
        	    );
    	}
    	/**
	 ...
	 *
	 * @return Radial_Eb2cFraud_Model_Resource_Risk_Service_Collection
	 */
	public function getEb2cFraudCollection()
	{
		return Mage::getResourceModel('radial_eb2cfraud/risk_service_collection')
	 ...
	 * @return Radial_Eb2cFraud_Model_Risk_Service
	 */
	public function getEb2cFraud(Mage_Sales_Model_Order $order)
	{
		return Mage::getModel('radial_eb2cfraud/risk_service')
	...
	public function getOrderSourceByArea(Mage_Sales_Model_Order $order)
	{
		return $this->_isAdminOrder($order)
			? Radial_Eb2cFraud_Model_System_Config_Source_Ordersource::DASHBOARD
			: Radial_Eb2cFraud_Model_System_Config_Source_Ordersource::WEBSTORE;
	}
	/**
