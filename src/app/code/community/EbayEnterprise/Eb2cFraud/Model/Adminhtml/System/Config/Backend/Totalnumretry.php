...
class EbayEnterprise_Eb2cFraud_Model_Adminhtml_System_Config_Backend_Totalnumretry extends Mage_Core_Model_Config_Data
{
    public function _afterLoad()
    {
	$objectCollectionSize = Mage::getModel('ebayenterprise_eb2cfraud/retryQueue')->getCollection()->getSize();	
